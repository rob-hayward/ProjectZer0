...
//     // Handle the 'statement-network' view - redirect to dedicated route
//     if (view === 'statement-network') {
//         console.debug(`[INIT-3] +page.ts: ${view} view detected, redirecting to dedicated route`);
//         throw redirect(307, '/graph/statement-network');
//     }
    
//     // Handle legacy 'create-definition' view - redirect to 'create-definition'
//     if (view === 'create-definition') {
//         console.debug(`[INIT-3] +page.ts: Legacy ${view} view detected, redirecting to create-definition`);
        
//         const wordParam = url.searchParams.get('word');
//         if (wordParam) {
//             const redirectUrl = `/graph/create-definition?word=${encodeURIComponent(wordParam)}`;
//             throw redirect(307, redirectUrl);
//         } else {
//             throw redirect(307, '/graph/dashboard');
//         }
...
//     // Handle the 'create-definition' view that needs word data
//     if (view === 'create-definition' as ViewType) {
//         const wordParam = url.searchParams.get('word');
