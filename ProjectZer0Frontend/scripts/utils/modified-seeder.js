// scripts/utils/modified-seeder.js
...
async function fetchWithAuth(endpoint, options = {}) {
    ...
    // Match the exact headers from a successful request in your browser
    const headers = {
...
// Function to create a statement - match exactly what your frontend does
...
async function main() {
    try {
        ...
        try {
            console.log('\nTesting authentication with a GET request:');
            const profileData = await fetchWithAuth('/user/profile');
            console.log('Authentication successful. User profile:', profileData);
        } catch (error) {
            console.warn('Authentication test failed, but continuing anyway:', error.message);
        }
